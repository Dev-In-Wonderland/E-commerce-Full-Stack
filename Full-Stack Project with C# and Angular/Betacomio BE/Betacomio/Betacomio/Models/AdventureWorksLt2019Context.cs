...
public partial class AdventureWorksLt2019Context : DbContext
{
    ...
    public virtual DbSet<ViewCompleteOrderHistory> ViewCompleteOrderHistories { get; set; }

    public virtual DbSet<ViewModel> ViewModels { get; set; }

    public virtual DbSet<ViewOrderHistoryDetail> ViewOrderHistoryDetails { get; set; }

    public virtual DbSet<ViewOrderHistoryHeader> ViewOrderHistoryHeaders { get; set; }

    public virtual DbSet<ViewParentCategory> ViewParentCategories { get; set; }

    public virtual DbSet<ViewProductsOverview> ViewProductsOverviews { get; set; }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<ViewCompleteOrderHistory>(entity =>
        {
            entity
                .HasNoKey()
                .ToView("View_CompleteOrderHistory");
        ...
        modelBuilder.Entity<ViewModel>(entity =>
        {
            ...
            entity.Property(e => e.Name).HasMaxLength(50);
            entity.Property(e => e.NomeModello)
                .HasMaxLength(50)
                .HasColumnName("nome_modello");
            entity.Property(e => e.ProductCategoryId).HasColumnName("ProductCategoryID");
            entity.Property(e => e.ProductModelId).HasColumnName("ProductModelID");
        });

        modelBuilder.Entity<ViewOrderHistoryDetail>(entity =>
        {
            entity
                .HasNoKey()
                .ToView("View_OrderHistoryDetail");
        ...
        modelBuilder.Entity<ViewOrderHistoryHeader>(entity =>
        {
            entity
                .HasNoKey()
                .ToView("View_OrderHistoryHeader");
        ...
        modelBuilder.Entity<ViewParentCategory>(entity =>
        {
            entity
                .HasNoKey()
                .ToView("View__ParentCategories");

            entity.Property(e => e.ParentProductCategoryName).HasMaxLength(50);
            entity.Property(e => e.ProductCategoryId).HasColumnName("ProductCategoryID");
        });

        modelBuilder.Entity<ViewProductsOverview>(entity =>
        {
            entity
                .HasNoKey()
                .ToView("View_ProductsOverview");
